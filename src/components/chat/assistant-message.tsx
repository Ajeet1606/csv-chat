        ...
        {message.analysis.pythonCode && (
          <Card className="bg-card border-border overflow-hidden border">
            <button
              ...
              className="bg-primary/8 hover:bg-primary/12 border-border flex w-full items-center justify-between border-b px-4 py-3 transition-colors"
            >
        ...
        {message.analysis.codeOutput && (
          <Card className="bg-card border-border overflow-hidden border">
            <button
              ...
              className="bg-accent/8 hover:bg-accent/12 border-border flex w-full items-center justify-between border-b px-4 py-3 transition-colors"
            >
              <span className="text-foreground flex items-center gap-2 text-sm font-semibold">
                <svg
                  className="h-4 w-4"
